$(window).on("load", function () {
        ...
        new ApexCharts(document.querySelector("#line-area-chart-5"), p).render();
        var h = {
            chart: {
                height: 270,
                toolbar: {
        ...
        new ApexCharts(document.querySelector("#line-area-chart-6"), p).render();
        var g = {
            chart: {
                height: 270,
                toolbar: {
        ...
        new ApexCharts(document.querySelector("#line-area-chart-7"), p).render();
        var g = {
            chart: {
                height: 270,
                toolbar: {
    ...
    function () {
        "use strict";
        if (0 < jQuery(".chat-application .user-chats").length) new PerfectScrollbar(".user-chats", {
            wheelPropagation: !1
        })
    }();
