...
$(window).on("load", function () {
  ...
  var notCheckoutlineChartoptions = {
    chart: {
      height: 100,
      type: 'area',
      toolbar: {
  ...
  var notCheckoutlineChart = new ApexCharts(
    document.querySelector("#line-area-chart-1"),
    notCheckoutlineChartoptions
  );

  notCheckoutlineChart.render();
  ...
  var visitorlineChart = new ApexCharts(
    document.querySelector("#line-area-chart-2"),
    visitorlineChartoptions
  );

  visitorlineChart.render();
  ...
  var feeedbacklineChart = new ApexCharts(
    document.querySelector("#line-area-chart-3"),
    feedbackChartoptions
  );

  feeedbacklineChart.render();

  // Line Area Chart - 4
  // ----------------------------------

  var intercomelineChartoptions = {
    chart: {
      height: 100,
      type: 'area',
      toolbar: {
  ...
  var intercomelineChart = new ApexCharts(
    document.querySelector("#line-area-chart-4"),
    intercomelineChartoptions
  );

  intercomelineChart.render();

  // Line Area Chart - 5
  // ----------------------------------

  var noticelineChartoptions = {
    chart: {
      height: 100,
      type: 'area',
      toolbar: {
  ...
  var noticelineChart = new ApexCharts(
    document.querySelector("#line-area-chart-5"),
    noticelineChartoptions
  );

  noticelineChart.render();
  ...
  var bookinglineChart = new ApexCharts(
    document.querySelector("#line-area-chart-6"),
    bookinglineChartoptions
  );
  ...
  var communitylineChart = new ApexCharts(
    document.querySelector("#line-area-chart-7"),
    communitylineChartoptions
  );

  communitylineChart.render();

  // Line Area Chart - 8
  // ----------------------------------

  var paniclineChartoptions = {
    chart: {
      height: 100,
      type: 'area',
      toolbar: {
  ...
  var paniclineChart = new ApexCharts(
    document.querySelector("#line-area-chart-8"),
    paniclineChartoptions
  );

  paniclineChart.render();

  // Line Area Chart - 9
  // ----------------------------------

  var vehiclelineChartoptions = {
    chart: {
      height: 100,
      type: 'area',
      toolbar: {
  ...
  var vehiclelineChart = new ApexCharts(
    document.querySelector("#line-area-chart-9"),
    vehiclelineChartoptions
  );

  vehiclelineChart.render();
